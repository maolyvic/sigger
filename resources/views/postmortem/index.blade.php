            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="{{ route('postmortem.create') }}" class="btn bg-success float-right"><i class="fas fa-plus"></i>
                            Nuevo</a>
                    </div>
                    <div class="card-body">
                        <x-adminlte-datatable id="table-postmortem" :heads="$heads" :config="$config" striped hoverable without-buttons>
                            @if (count($invivos) > 0)
