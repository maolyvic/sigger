<div class="flex-shrink-0 w-64 bg-gray-800 text-white flex flex-col">
    ...
    <nav class="flex-1 px-2 py-4 space-y-2">
        ...
        <a href="{{ route('dashboard') }}"
            class="flex items-center px-4 py-2 rounded-md hover:bg-gray-700 {{ request()->routeIs('dashboard') ? 'bg-gray-900' : '' }}">
        ...
        <div x-data="{ open: {{ request()->routeIs('causas.*') ? 'true' : 'false' }} }">
            ...
            <button @click="open = !open"
                class="w-full flex justify-between items-center px-4 py-2 rounded-md hover:bg-gray-700 focus:outline-none {{ request()->routeIs('causas.*') ? 'bg-gray-900' : '' }}">
        ...
        <div x-data="{ open: {{ request()->routeIs('evaluaciones.*') ? 'true' : 'false' }} }">
            {{-- Botón que controla el desplegable --}}
            <button @click="open = !open"
                class="w-full flex justify-between items-center px-4 py-2 rounded-md hover:bg-gray-700 focus:outline-none {{ request()->routeIs('evaluaciones.*') ? 'bg-gray-900' : '' }}">
